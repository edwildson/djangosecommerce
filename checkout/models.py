...
class CartItemManager(models.Manager):
    def add_item(self, cart_key, product):
        ...
        # cart_item, created = self.get_or_create(cart_key=cart_key, product=product, price = product.price)
...
class Order(models.Model):
    ...
    def pagseguro(self):
        pg = PagSeguro(
            email=settings.PAGSEGURO_EMAIL, token=settings.PAGSEGURO_TOKEN, config={
